...
namespace remani_planner
{
  ...
  struct SingulTrajData
  {
    ...
    Eigen::VectorXd getPos(double t) const{
        double local_t = t;
        int pieceIdx = locatePieceIdx(local_t);
        return singul_traj[pieceIdx].traj.getPos(local_t);
    }
    ...
    Eigen::VectorXd getVel(double t) const
    {
      double local_t = t;
      int pieceIdx = locatePieceIdx(local_t);
      return singul_traj[pieceIdx].traj.getVel(local_t);
    }
    ...
    Eigen::VectorXd getAcc(double t) const
    {
      double local_t = t;
      int pieceIdx = locatePieceIdx(local_t);
      return singul_traj[pieceIdx].traj.getAcc(local_t);
    }
    ...
    Eigen::VectorXd getJer(double t) const
    {
      double local_t = t;
      int pieceIdx = locatePieceIdx(local_t);
      return singul_traj[pieceIdx].traj.getJer(local_t);
    }
